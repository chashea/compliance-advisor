...
export default function SubjectRights() {
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-xl font-semibold text-slate-800">Subject Rights Requests ({data.requests.length})</h2>

      {pieData.length > 0 && (
        <div className="max-w-md">
          <h3 className="mb-2 text-sm font-medium text-slate-600">Status Breakdown</h3>
