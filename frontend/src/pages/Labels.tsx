...
export default function Labels() {
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-xl font-semibold text-slate-800 dark:text-slate-100">Information Protection Labels</h2>

      <div>
        <h3 className="mb-2 text-sm font-medium text-slate-600 dark:text-slate-300">Sensitivity Labels ({data.sensitivity_labels.length})</h3>
      ...
      <div>
        <h3 className="mb-2 text-sm font-medium text-slate-600 dark:text-slate-300">Retention Labels ({data.retention_labels.length})</h3>
      ...
      <div>
        <h3 className="mb-2 text-sm font-medium text-slate-600 dark:text-slate-300">Retention Events ({data.retention_events.length})</h3>
